...
namespace Proyecto
{
    public partial class Frm_Vendedor : Form
    {
       ...
       VENDEDOR_ENTIDAD cliente_entidad = new VENDEDOR_ENTIDAD();
        VENDEDOR_NEG cliente_neg = new VENDEDOR_NEG();
        ...
        private void btnmodificar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cliente_entidad.Sueldo = Convert.ToDouble(txtsueldo.Text);
        ...
        private void tblDatos_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                txtsueldo.Text = tblDatos[5, grilla].Value.ToString();
